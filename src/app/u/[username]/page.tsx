  ...
  return (
    <div className="min-w-full min-h-screen bg-blue-600 text-white">
      ...
      <div className="container mx-auto flex flex-col items-center gap-3">
        ...
        <input type="text" className="sm:px-10 w-[90%] px-5 rounded-lg shadow-lg py-4"/>
        <button style={{ opacity: allowMessage ? 1 : 0.5 }} className="lg:px-10 px-5 py-2 rounded-md bg-black text-white w-max" disabled={!allowMessage}>
          {isSending ? 'Sending...' : 'Send'}
        </button>
      </div>

      <div className="container ml-24 py-4 md:px-7 flex flex-col space-y-2 items-start">
        <button className="rounded-md py-2 px-4 bg-black text-white w-max">Suggest Messages</button>
        ...
        <section className=" w-[85%] flex flex-col space-y-3 py-3 px-3 bg-white text-black rounded-lg shadow-lg ">
          ...
          <div className="flex flex-col space-y-1">
            <p className="text-md border-b-2 border-grew-200 pb-1">Message content 1</p>
          </div>
